...
description: Desarrollar y revisar el frontend React/Vite de RealStep. Usar ante tareas sobre componentes, hooks de interfaz, reducers de selección, CSS, responsive, accesibilidad, navegación, UX, animaciones o comportamiento visual dentro de src/. Para investigaciones de rendimiento medibles, combinar con analyze-performance.
---
...
4. Revisar `src/main.jsx` antes de alterar el orden o alcance de estilos.
...
- Reutilizar selectores de `src/data/catalogSelectors.js`.
