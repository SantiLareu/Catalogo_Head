...
- una aplicación React/Vite en `react-app/`;
...
- No modificar archivos generados, manifests, firmas o `react-app/dist` salvo que el flujo solicitado lo requiera.
...
- Mantener React y Vite dentro de la estructura existente de `react-app/`.
